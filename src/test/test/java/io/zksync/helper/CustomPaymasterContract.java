...
public class CustomPaymasterContract extends Contract {
    ...
    public static class Transaction extends DynamicStruct {
        ...
        public Transaction(BigInteger txType, BigInteger from, BigInteger to, BigInteger gasLimit, BigInteger gasPerPubdataByteLimit, BigInteger gasPrice, BigInteger paymaster, List<BigInteger> reserved, byte[] data, byte[] signature, List<byte[]> factoryDeps, byte[] paymasterInput, byte[] reservedDynamic) {
            super(new org.web3j.abi.datatypes.generated.Uint8(txType),new org.web3j.abi.datatypes.generated.Uint256(from),new org.web3j.abi.datatypes.generated.Uint256(to),new org.web3j.abi.datatypes.generated.Uint256(gasLimit),new org.web3j.abi.datatypes.generated.Uint256(gasPerPubdataByteLimit),new org.web3j.abi.datatypes.generated.Uint256(gasPrice),new org.web3j.abi.datatypes.generated.Uint256(paymaster),new org.web3j.abi.datatypes.generated.StaticArray6<>(Uint256.class, reserved.stream().map(Uint256::new).collect(Collectors.toList())),new org.web3j.abi.datatypes.DynamicBytes(data),new org.web3j.abi.datatypes.DynamicBytes(signature),new org.web3j.abi.datatypes.DynamicArray<>(Bytes32.class, factoryDeps.stream().map(Bytes32::new).collect(Collectors.toList())),new org.web3j.abi.datatypes.DynamicBytes(paymasterInput),new org.web3j.abi.datatypes.DynamicBytes(reservedDynamic));
            this.txType = txType;
            this.from = from;
            this.to = to;
        ...
        public Transaction(Uint8 txType, Uint256 from, Uint256 to, Uint256 gasLimit, Uint256 gasPerPubdataByteLimit, Uint256 gasPrice, Uint256 paymaster, StaticArray6<Uint256> reserved, DynamicBytes data, DynamicBytes signature, DynamicArray<Bytes32> factoryDeps, DynamicBytes paymasterInput, DynamicBytes reservedDynamic) {
            super(txType,from,to,gasLimit,gasPerPubdataByteLimit,gasPrice,paymaster,reserved,data,signature,factoryDeps,paymasterInput,reservedDynamic);
            ...
            this.gasPrice = gasPrice.getValue();
